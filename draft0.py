...
if __name__ == "__main__":
    ...
    rec_world = [0.584, 0.75]   # a rectangle world start from (0, 0) to this pos
    ...
    flag_kernel = 1 # 1 cubic-spline; 2 Wendland C2
    ...
    gguishow(case1, solver, rec_world, screen_to_world_ratio, stepwise=20, iparticle=None, color_title="pressure Pa", kradius=1.5, write_to_disk=0)
