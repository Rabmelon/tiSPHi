...
if __name__ == "__main__":
    ...
    av_alpha_Pi, av_beta_Pi = 0.0, 0.0

    case1 = ParticleSystem(world=rec_world, radius=0.001)
    case1.gen_boundary_dummy()
    # case1.gen_boundary_rep()
    case1.add_cube(lower_corner=[0.0, 0.0], cube_size=[0.2, 0.1], material=mat, density=rho)
