...
if __name__ == "__main__":
    ...
    gguishow(case1, solver, rec_world, screen_to_world_ratio, stepwise=20, iparticle=None, color_title="velocity m/s", kradius=1.5, write_to_disk=1)
