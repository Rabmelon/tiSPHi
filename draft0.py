...
if __name__ == "__main__":
    ...
    rec_world = [2, 0.6]   # a rectangle world start from (0, 0) to this pos
    ...
    case1.add_cube(lower_corner=[0.9, 0], cube_size=cube_size, color=(149/255,99/255,51/255), material=mat, density=rho)
    ...
    gguishow(case1, solver, rec_world, screen_to_world_ratio, stepwise=10, iparticle=None, kradius=1.5, write_to_disk=False, color_title="density")
